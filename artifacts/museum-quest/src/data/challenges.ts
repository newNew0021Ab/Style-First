...
export const challenges: Challenge[] = [
  ...
  },
  {
    id: 3,
    question:
      "Найди работу, где изображён герой мистических сказок. Он соединяет в себе пламя и крылья.",
    icon: Flame,
    choices: [
      "«История про Кащея»",
  ...
  },
  {
    id: 5,
    question:
      "Найди работу с героем, который прячет иглу в яйце. А смерти у него нет, зато есть сундук и дуб.",
    icon: Skull,
